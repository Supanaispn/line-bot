...
module.exports = async function (Api) {
    Api.get("/webhook", (req, res) => res.end(`I'm listening. Please access with POST.`));
    ...
    Api.post("/webhook", line.middleware(config), async (req, res) => {
        try {
            ...
            if (replyToken == "00000000000000000000000000000000" && message.text === "Hello, world")
                ...
                req.body.events.map(async (d) => {
                    ...
                    switch (d.message.text) {
                        ...
                        case "ค่าไฟ":
                            ...
                            break;
                        case "โควิด":
                            await cron_model.call_covid(user);
                            break;
                        default:
